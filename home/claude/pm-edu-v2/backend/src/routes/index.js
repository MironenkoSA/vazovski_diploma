...
// ── Student ────────────────────────────────────────────
r.get ('/my/courses',         auth, coursesCtrl.myCourses);  // no role guard - works for all
r.post('/my/auto-enroll',     auth, role('student'), coursesCtrl.autoEnrollFree);
...
r.post('/lessons/:id/complete',    auth, role('student'), lessonsCtrl.completeLesson);
r.post('/lessons',                 auth, role('teacher','admin'), lessonsCtrl.createLesson);
r.put ('/lessons/:id',             auth, role('teacher','admin'), lessonsCtrl.updateLesson);
...
r.put('/homework/:id/resubmit',      auth, role('student'), lessonsCtrl.resubmitHw);
